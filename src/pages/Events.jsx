...
export default function EventPage() {
  const [events, setEvents] = useState([
    {
      ...
      description:
        "A week of fun, adventure, and spiritual growth for middle and high school students.",
      date: "Jul 14, 2025",
      time: "9:00 AM",
      location: "Camp Wilderness",
      image:
        "https://images.unsplash.com/photo-1501700493788-fa1a6e57a3a1?auto=format&fit=crop&w=500&q=60",
      featured: false,
    },
    {
      id: 2,
  ...
  return (
    <div className="p-10 bg-[#f7f9fc] min-h-screen">
      ...
      {/* MODALS */}
      {openAdd && (
        <AddEventModal onClose={() => setOpenAdd(false)} onSubmit={handleAddEvent} />
      )}
